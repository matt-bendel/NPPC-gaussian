...
class DataTransform:
    def __init__(self, d):
        ...
        e_vecs = np.load(f'/home/bendel.8/Git_Repos/NPPC-gaussian/data/stats_{d}d/gt_e_vecs.npy')
...
class GaussianDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_set, self.valid_set, self.test_set = random_split(data, [70000, 20000, 10000])
